...
namespace Qqqfapi
{
    public class Group
    {
        ...
        {
            string fileListJson = HttpGet("https://pan.qun.qq.com/cgi-bin/group_file/get_file_list?src=qpan&gc=" + gid + "&bkn=" + bkn + "&folder_id=" + folderId + "&start_index=0&cnt=!!!YOUR_QQ_ID!!!&filter_code=0&show_onlinedoc_folder=0");
